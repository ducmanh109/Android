...
import com.example.lemonapp.DrawableMatcher.withDrawable
import com.example.lemonapp.R
...
open class BaseTest {
     ...
     */
    fun juiceLemon() {
        while (onView(withDrawable(R.drawable.lemon)).isPresent()) {
     ...
     */
    fun drinkJuice() {
        onView(withDrawable(R.drawable.water_glass))
            .perform(click())
    }
     ...
     */
    fun restart() {
        onView(withDrawable(R.drawable.water_glass_1))
            .perform(click())
    }
