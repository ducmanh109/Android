    ...
    private fun clickLemonImage() {
        ...
        when (lemonadeState){
            SELECT-> {
                ...
                Toast.makeText(this, ""+lemonTree.pick(),Toast.LENGTH_SHORT).show()
                squeezeCount=0
            }
            SQUEEZE->{
                lemonSize = lemonTree.pick()
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            ...
            DRINK -> {
                ...
                lemonImage.setImageResource(R.drawable.water_glass)
            }
            RESTART -> {
                textAction.text = getString(R.string.lemon_empty_glass)
                lemonImage.setImageResource(R.drawable.water_glass_1)
            }
        }
    }
    /**
